 ...
 */
package org.openmrs.module.internlmsgs.dao;
 ...
 */
public class InternlMessagesDaoTest extends BaseModuleContextSensitiveTest {
	...
	public void saveInternlMessage_shouldSaveAllPropertiesInDb() {
		//Given
		InternlMessage item = new InternlMessage();
		
		//When
		dao.saveInternlMessage(item);
